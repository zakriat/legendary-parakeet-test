                            ...
                            <div class="card-body">
                                ...
                                <ul class="iq-contact-detail list-inline p-0 m-0">
                                    <li class="d-flex align-items-center justify-content-center mb-3">
                                        <svg class="heading-color" fill="none" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                                    ...
                                    <li class="d-flex align-items-center justify-content-center">
                                        <svg class="heading-color" width="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
