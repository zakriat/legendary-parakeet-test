...
class CityController extends Controller
{
    ...
    public function index_list(Request $request)
    {
        ...
        // If state_id is provided, filter by state (original behavior)
        if (isset($state_id)) {
            $query->where('state_id', $state_id);
        }
        // If country_id is provided but no state_id, load all cities for UK states (new behavior)
        elseif (isset($country_id)) {
            // Join with states table to filter cities by country
