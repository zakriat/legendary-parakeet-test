        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <Multiselect id="state-list" v-model="state" :value="state" :placeholder="$t('receptionist.placeholder_select_state')" v-bind="singleSelectOption" :options="states.options" class="form-group"></Multiselect>
...
onMounted(() => {
  ...
  getVendorList()
  getClinic()
  // Auto-load UK states and cities on mount (independent selection)
  getState(229)
  getCity(null) // Load all UK cities, not filtered by state
})
