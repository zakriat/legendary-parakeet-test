...
export const CLINIC_CENTER_LIST = ({id = '', exclude_assigned_receptionist = false, current_receptionist_clinic_id = ''}) => {
  const params = new URLSearchParams()
  if (id !== '') params.append('vendor_id', id)
  if (exclude_assigned_receptionist) params.append('exclude_assigned_receptionist', '1')
  if (current_receptionist_clinic_id !== '') params.append('current_receptionist_clinic_id', current_receptionist_clinic_id)
  return { path: `clinics/index_list?${params.toString()}`, method: 'GET' }
}
