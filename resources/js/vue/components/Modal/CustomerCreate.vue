                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row" id="form-offcanvas">
                            ...
                            <div class="form-group col-md-12">
                                <label for="nhs_number">NHS Number <span class="text-muted small">(if known)</span></label>
                                <input type="text" class="form-control" v-model="nhs_number" placeholder="Enter NHS Number" />
                            </div>
                            <div class="form-group col-md-12">
